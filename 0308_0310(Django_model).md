...
- **ORM**
  ...
  - OOP 프로그램밍에서 RDBMS을 연동할 때, 데이터베이스와 객체지향 프로그래밍 언어 간의 호환되지 않는 데이터를 변환하는 프로그래밍 기법
...
- **HTTP method**
  ...
  - **사이트 간 요청 위조(Cross-site request forgery)**
    ...
    - Django는 CSRF에 대항하여 middelwae와 template tag를 제공
    - CSRF라고도 함
  ...
  - **CSRF 공격 방어**
    ...
    - **CsrfViewMiddleware**
      ...
      - CSRF 공격 관련 보안 설정
      - Middleware
        - 공통 서비스 및 기능을 애플리케이셔넹 제공하는 소프트웨어
